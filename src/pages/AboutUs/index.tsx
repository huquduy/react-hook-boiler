  ...
  return (
    <div className='term-page'>
      ...
      <div className="container">
        <h1 className="text-center">Selamat Datang Di HOKIBET188.com</h1>
        <h2 className="text-center">SITUS JUDI ONLINE DAN PERMAINAN CASINO TERPERCAYA</h2>
